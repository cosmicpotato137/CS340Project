...
class sbbst():
    ...
    def leftRotate(self, node):
        ...
        node.height = 1 + max(self.getHeight(node.left),
                              self.getHeight(node.right))
        rnode.height = 1 + max(self.getHeight(rnode.left),
                               self.getHeight(rnode.right))
        # Return the new node
        return rnode
    ...
    def rightRotate(self, node):
        ...
        node.height = 1 + max(self.getHeight(node.left),
                              self.getHeight(node.right))
        lnode.height = 1 + max(self.getHeight(lnode.left),
                               self.getHeight(lnode.right))
        # Return the new node
        return lnode
        ...
        while queue:
            ...
            for q in queue:
                if q.left and q.right:
                    ...
                    # Print of the arms of the Tree
                    nextline += ' ' * \
                        (self.sumsizes[q.left.place+1]-nextpast-1) + '/'
                    ...
                    # Print of the arms of the Tree
                    nextline += ' ' * \
                        (self.sumsizes[q.right.place]-nextpast) + \
    ...
    while queue:
        ...
        for q in queue:
            if q.left and q.right:
                ...
                aux.append(q.right)
                # Print of the _ and the values of the nodes
                line += ' '*(sumsizes[q.left.place+1]-past) + '_'*(sumsizes[q.place]-sumsizes[q.left.place+1]) + str(
                    q.val) + '_'*(sumsizes[q.right.place]-sumsizes[q.place+1])
                ...
                line += ' '*(sumsizes[q.place]-past)+str(q.val) + \
                    '_'*(sumsizes[q.right.place]-sumsizes[q.place+1])
                past = sumsizes[q.right.place]
                # Print of the arms of the Tree
                nextline += ' ' * \
                    (sumsizes[q.right.place]-nextpast) + \
                    '\\' + ' '*(sizes[q.right.place]-1)
                nextpast = sumsizes[q.right.place+1]
            else:
                line += ' '*(sumsizes[q.place]-past)+str(q.val)
                past = sumsizes[q.place+1]
